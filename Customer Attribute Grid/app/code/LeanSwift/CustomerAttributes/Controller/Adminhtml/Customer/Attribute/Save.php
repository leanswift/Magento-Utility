...
use LeanSwift\CustomerAttributes\Helper\Customer as HelperCustomer;
use LeanSwift\CustomerAttributes\Helper\Data as HelperData;
 ...
 */
class Save extends \LeanSwift\CustomerAttributes\Controller\Adminhtml\Customer\Attribute
{
    /**
     * @var HelperData
     */
        ...
        if ($this->getRequest()->isPost() && $data) {
            ...
            try {
                $this->_eventManager->dispatch(
                    'leanswift_customer_attributes_before_save',
                    ['attribute' => $attributeObject]
                );
                $attributeObject->save();
                $this->_eventManager->dispatch(
                    'leanswift_customer_attributes_save',
                    ['attribute' => $attributeObject]
                );
