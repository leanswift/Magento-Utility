 ...
 */
namespace LeanSwift\CustomerAttributes\Block\Adminhtml\Customer\Attribute\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * Customer data
     *
     * @var \LeanSwift\CustomerAttributes\Helper\Data
     */
     ...
     * @param \LeanSwift\CustomerAttributes\Helper\Data $customerData
     * @param array $data
     */
    public function __construct(
        ...
        \LeanSwift\CustomerAttributes\Helper\Data $customerData,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        /* @var $helper \LeanSwift\CustomerAttributes\Helper\Data */
        ...
        $this->_eventManager->dispatch(
            'leanswift_customer_attributes_edit_tab_general_prepare_form',
