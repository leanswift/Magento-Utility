...
class UpgradeSchema implements UpgradeSchemaInterface
{
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $installer->run(
            "INSERT INTO  `{$installer->getTable('url_rewrite')}` (`url_rewrite_id`, `entity_type`, `entity_id`, `request_path`, `target_path`, `redirect_type`, `store_id`, `description`, `is_autogenerated`, `metadata`) VALUES (NULL, 'custom', '0', 'clearlog', 'logmanager/index/clearlog', '0', '0', NULL, '0', NULL)"
        );
        $installer->run(
            "INSERT INTO  `{$installer->getTable('url_rewrite')}` (`url_rewrite_id`, `entity_type`, `entity_id`, `request_path`, `target_path`, `redirect_type`, `store_id`, `description`, `is_autogenerated`, `metadata`) VALUES (NULL, 'custom', '0', 'createsymlink', 'logmanager/index/createsymlink', '0', '0', NULL, '0', NULL)"
        );
        $installer->endSetup();
    }
