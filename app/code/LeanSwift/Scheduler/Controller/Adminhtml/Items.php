...
namespace LeanSwift\Scheduler\Controller\Adminhtml;
...
abstract class Items extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu('LeanSwift_Scheduler::items')->_addBreadcrumb(__('Items'), __('Schedule Table'));
        return $this;
    }
    ...
    {
        return $this->_authorization->isAllowed('LeanSwift_Scheduler::items');
    }
}
